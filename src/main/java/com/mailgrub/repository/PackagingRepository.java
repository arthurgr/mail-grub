...
public interface PackagingRepository
  ...
  Page<Packaging> findByUserId(String userId, Pageable pageable);

  Page<Packaging> findByUserIdAndPackagingMaterialsContainingIgnoreCase(
      String userId, String packagingMaterials, Pageable pageable);
}
